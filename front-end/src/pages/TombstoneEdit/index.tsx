...
const TombstoneEdit: React.FC<TombstoneEditProps> = ({ current }) => {
...
export default connect(({ tombstoneEdit }: { tombstoneEdit: StateType }) => ({
  current: tombstoneEdit.current,
}))(TombstoneEdit);
